...
///////////////////////////////////////////////////////////////////////////////
Line::Line(long double slope, long double intercept) {
    set(slope, intercept);
}
...
void Line::set(long double slope, long double intercept) {
...
Vector3 Line::intersect(const Line& line) {
    ...
    long double alpha = v3.dot(v4) / dot;
